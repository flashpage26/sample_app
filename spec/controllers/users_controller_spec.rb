...
describe UsersController do
  ...
  describe "GET 'show'" do
	...
	it "should show the user's microposts" do
		...
		mp2 = Factory(:micropost, :user => @user, :content => "Baz garply")
		get :show, :id => @user
  ...
  describe "POST 'create'" do
	...
	describe "success" do
	  ...
	  before(:each) do
		@attr = { :name => "New user", :email => "newuser@example.com", :password => "foobar", :password_confirmation => "foobar"}
	  end
  ...
  describe "PUT 'update'" do
	...
	describe "successes" do
		...
		before(:each) do
			@attr = { :name => "New name", :email => "newname@example.com", :password => "barfoo", :password_confirmation => "barfoo"}
		end
